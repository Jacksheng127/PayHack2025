...
import NetworkGraphCytoscape from './NetworkGraphCytoscape3';
import TransactionDetails from './TransactionDetails';
import NetworkGraphCytoscape2 from './NetworkGraphCytoscape';
    ...
    <div className="dashboard-container">
      ...
      <div className="right-dashboard-area">
        <div className="network-graph-section">
            <NetworkGraphCytoscape2 onNodeClick={handleNodeClick} />
