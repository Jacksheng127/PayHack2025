...
const Receivers: React.FC = () => {
    const [data, setData] = useState([
        { name: 'Receiver A', value: 400 },
        { name: 'Receiver B', value: 300 },
        { name: 'Receiver C', value: 300 },
        { name: 'Receiver D', value: 200 },
        { name: 'Receiver E', value: 278 },
        { name: 'Receiver F', value: 189 },
    ]);
    
    return (
        <div className="receivers-section">
            <h2 className="section-title">Receivers Overview</h2>
